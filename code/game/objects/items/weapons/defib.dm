// procs may need to be moved later
...
/obj/item/weapon/defibrillator
	...
	var/obj/item/weapon/material/twohanded/shockpaddles/paddles
...
/obj/item/weapon/defibrillator/ui_action_click()
	if(usr.get_equipped_item(slot_back) == src)
		toggle_paddles()
	else
...
/obj/item/weapon/defibrillator/proc/make_paddles()
	return new /obj/item/weapon/material/twohanded/shockpaddles(src)
...
/obj/item/weapon/defibrillator/compact/ui_action_click()
	if(usr.get_equipped_item(slot_belt) == src)
		toggle_paddles()
	else
...
/obj/item/weapon/material/twohanded/shockpaddles
...
/obj/item/weapon/material/twohanded/shockpaddles/New(mainunit)
	..()
...
/obj/item/weapon/material/twohanded/shockpaddles/update_icon()
	icon_state = "defibpaddles[wielded]"
	item_state = "defibpaddles[wielded]"
	if(cooldown)
		icon_state = "defibpaddles[wielded]_cooldown"

/obj/item/weapon/material/twohanded/shockpaddles/suicide_act(mob/user)
...
/obj/item/weapon/material/twohanded/shockpaddles/dropped(mob/user as mob)
	if(user)
...
/obj/item/weapon/material/twohanded/shockpaddles/proc/check_defib_exists(mainunit, var/mob/living/carbon/human/M, var/obj/O)
...
/obj/item/weapon/material/twohanded/shockpaddles/attack(mob/M, mob/user)
	var/tobehealed
	...
	if(!ishuman(M))
		...
		if(user.zone_sel && user.zone_sel.selecting == "chest")
			...
			if(do_after(user, 30)) //beginning to place the paddles on patient's chest to allow some time for people to move away to stop the process
				...
				var/tlimit = 12000 //past this much time the patient is unrecoverable (in deciseconds)
				var/tloss = 3600 //brain damage starts setting in on the patient after some time left rotting
				var/total_burn	= 0
				var/total_brute	= 0
...
*/
					if(H.stat == 2)
						...
						for(var/obj/item/organ/I in H.internal_organs)
							total_brute	+= I.damage
//							total_burn	+= I.burn_dam
