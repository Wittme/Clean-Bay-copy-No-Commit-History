...
/datum/job/blueshield
	...
	idtype = /obj/item/weapon/card/id/silver
	req_admin_notify = 1
	access = list(access_security, access_eva, access_sec_doors, access_court,
			            access_morgue, access_maint_tunnels, access_all_personal_lockers,
			            access_research, access_engine, access_mining, access_medical, access_construction, access_mailsorting,
			            access_heads, access_gateway, access_external_airlocks, access_deptguard)
	minimal_access = list(access_security, access_eva, access_sec_doors, access_court,
			            access_morgue, access_maint_tunnels, access_all_personal_lockers,
			            access_research, access_engine, access_mining, access_medical, access_construction, access_mailsorting,
			            access_heads, access_gateway, access_external_airlocks, access_deptguard)
