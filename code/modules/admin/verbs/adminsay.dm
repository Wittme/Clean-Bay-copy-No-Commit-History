...
/client/proc/cmd_mod_say(msg as text)
	...
	for(var/client/C in admins)
		C << "<span class='mod_channel'>" + create_text_tag("mod", "STAFF:", C) + " <span class='name'>[sender_name]</span>(<A HREF='?src=\ref[C.holder];adminplayerobservejump=\ref[mob]'>JMP</A>): <span class='message'>[msg]</span></span>"
